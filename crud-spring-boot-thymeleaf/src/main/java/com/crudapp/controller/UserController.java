...
public class UserController {
	...
	public String saveUser(@RequestParam("name") String name, @RequestParam("dob") Date dob,
			...
			@RequestParam("image") MultipartFile image, RedirectAttributes redirectAttributes, Model model)
			throws IOException {
	...
	public String saveUpdatedUser(@PathVariable("id") Long id, @RequestParam("name") String name,
			...
			@RequestParam("oldImage") String oldImageName, Model model, RedirectAttributes redirectAttributes)
			throws IOException {
